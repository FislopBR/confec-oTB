                ...
                <form method="POST" action="{{ route('pedidos.store') }}" id="form-pedido">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantidade" id="quantidade" min="1" value="1" class="border-gray-300 rounded-md shadow-sm mt-1 block w-full" required>
                        </div>
